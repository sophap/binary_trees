...
<div class="Overlay--hidden Overlay-backdrop--center" data-modal-dialog-overlay>
  ...
  <div data-view-component="true">      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li>
          <clipboard-copy data-toggle-for="blob-more-options-details" aria-label="Copy path" value="0-binary_tree_node.c" data-view-component="true" class="dropdown-item cursor-pointer">
...
<template class="js-line-alert-template">
  ...
  <table data-hpc class="highlight tab-size js-file-line-container js-code-nav-container js-tagsearch-file" data-tab-size="8" data-paste-markdown-skip data-tagsearch-lang="C" data-tagsearch-path="0-binary_tree_node.c">
        <tr>
